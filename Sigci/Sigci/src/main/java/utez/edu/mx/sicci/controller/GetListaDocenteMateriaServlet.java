...
@WebServlet(name="GetListaDocenteMateriaServlet", value = "/getListaDocenteMateria")
public class GetListaDocenteMateriaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("listaDocenteMateria.jsp");
        rd.forward(req,resp);
    }
}
