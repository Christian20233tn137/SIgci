...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/alerta.css">
</head>
<body>
<header>
    ...
    <div class="container">
        ...
        <div class="login-box">
            <center><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                         width="250.000000pt" height="150.000000pt" viewBox="0 0 96.000000 74.000000"
                         preserveAspectRatio="xMidYMid meet">

                <g transform="translate(0.000000,74.000000) scale(0.100000,-0.100000)"
                   fill="#FF0000" stroke="none">
                    <path d="M452 573 c-11 -10 -64 -89 -116 -176 -149 -246 -149 -247 162 -247
           217 0 221 0 236 22 9 12 16 31 16 41 0 26 -206 363 -226 371 -27 10 -51 7 -72
           -11z m58 -204 c0 -62 -2 -70 -17 -67 -14 2 -19 15 -21 61 -3 57 10 93 29 81 5
           -3 9 -37 9 -75z m6 -100 c8 -14 -21 -43 -35 -35 -6 4 -11 16 -11 27 0 21 34
           27 46 8z"/>
                </g>
            </svg></center>
            <center>La contraseña o correo que ingresaste es invalido </center>
            <br>


            <center><a class="volver" href="login.jsp">REGRESAR</a></center>
            <br>
