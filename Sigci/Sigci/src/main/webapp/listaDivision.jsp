...
<head>
    ...
    <script src="<%= request.getContextPath() %>/js/seekerDivision.js"></script>
...
<center>
    <table id="listaDivision">
        ...
        <tr>
            <td><%=d.getNombre()%> </td>
            <td><a href="updateDivision?id_division=<%=d.getId_division()%>">
       ...
       -1221 669 -1890 605z"/>
            ...
            <td><a onclick="return confirmDelete();" href="borrarDivision?id_division=<%=d.getId_division()%>">
