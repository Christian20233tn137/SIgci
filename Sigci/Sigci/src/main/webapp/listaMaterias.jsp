...
<br>
<center><h2>Gestionar Materias</h2></center>
...
<center>
    ...
    <tr>
        ...
        <td><a href="updateMateria?id_materia=<%=m.getId_materia()%>">
       ...
       -1221 669 -1890 605z"/>
        ...
        <td><a onclick="confirmDelete(event, 1)" href="borrarMateria?id_materia=<%=m.getId_materia()%>">
    ...
    function confirmDelete(event, id_grupo) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`borrarMateria?id_materia=${id_materia}`, {
                    method: 'GET',
                })
                    .then(response => {
                        if (response.ok) {
